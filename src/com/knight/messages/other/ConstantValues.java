...
public class ConstantValues {
	public static final String registrationTable = "customer_registration";
	public static final String serviceTable = "taf_services";
	public static final String lgnTable = "tbl_login";
	public static final String SalesTable = "sales";
	public static final String PurchasesTable = "purchases";
