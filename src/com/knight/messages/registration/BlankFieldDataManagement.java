...
public class BlankFieldDataManagement {
	...
	public Response insertBlankFieldManagement(BlankField blankField){
	...
	@Path("/view")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response viewBlankFieldManagement(ViewRequestInput viewRequestInput){
		...
		try{
			...
			if(dbConnection != null) {
				...
				if(viewRequestInput.getDateInterval().isEmpty() || viewRequestInput.getDateInterval().equalsIgnoreCase("no") || viewRequestInput.getDateInterval().equalsIgnoreCase("false")) {
					String query = "select * from " + ConstantValues.BlankFieldTable + " where userId = '" + viewRequestInput.getUserId() +"' LIMIT 5";
					...
					String query = "select * from " + ConstantValues.BlankFieldTable + " where userId = '" + viewRequestInput.getUserId() +"' AND date between '" + viewRequestInput.getFromDate()
