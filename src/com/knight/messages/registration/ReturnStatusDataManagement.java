...
public class ReturnStatusDataManagement {
	...
	public Response insertReturnStatus(ReturnStatus returnStatus){
	...
	@Path("/view")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response viewReturnStatus(ViewRequestInput viewRequestInput){
		...
		try{
			...
			if(dbConnection != null) {
				...
				if(viewRequestInput.getDateInterval().isEmpty() || viewRequestInput.getDateInterval().equalsIgnoreCase("no") || viewRequestInput.getDateInterval().equalsIgnoreCase("false")) {
					String query = "select * from " + ConstantValues.ReturnStatusTable + " where userId = '" + viewRequestInput.getUserId() +"' LIMIT 5";
					...
					String query = "select * from " + ConstantValues.ReturnStatusTable + " where userId = '" + viewRequestInput.getUserId() +"' AND date between '" + viewRequestInput.getFromDate()
